...
class Fun(commands.Cog):
	...
	@commands.slash_command(name='8ball', description='Settle an argument with this irrefutable evidence', guild_ids=GUILD_IDS)
	...
	async def rsw(self, ctx, sussy_length=1):
		random_quotes = [
            'real', 'sus', 'sussy', 'monger', 'ok bud', 'bad', 'amogus', 'no',
            'yes', 'gud', 'mald', 'trash', 'lol', 'pro', 'bruh', 'very', 'me when',
            'i enjoy', 'cring', 'omg', 'poop', 'wtf', 'right now', 'agree',
            'moment', 'L', 'ez', 'so', 'lmao', 'mommento', 'literally', 'wow',
            'rage'
        ]
		response2 = ''
